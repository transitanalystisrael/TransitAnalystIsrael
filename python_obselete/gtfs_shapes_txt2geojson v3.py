...
#   parent_path_gtfs = 'C:\\transitanalyst\\gtfs\\'
...
#gtfspathin = parent_path+gtfsdir+'\\' # input filtered gtfs path is \processed
gtfspathin = parent_path_gtfs+gtfsdir+'\\' # input gtfs path is \gtfs
gtfspath = gtfspathin

...
#   gtfsdir = 'israel20180106-jerusalem'
...
#
# output to file of routes with tripcount and stops count - 'routeswtripcountperdayjerusalem.txt'
# output to file of unique routes - 'uniquerouteswtripcountat'+sstarttimename+sstoptimename+'jerusalem.txt'
...
routeswithtripcountfile = 'routeswtripcountperdayjerusalem.txt'
uniquerouteswithtripcountattimefile = 'uniquerouteswtripcountat'+sstarttimename+sstoptimename+'jerusalem.txt'

...
# -*- coding: utf-8 -*-
# 
# restore past bucket from backup bucket on AWS S3 cloud
#
...
print('********** restore past in AWS S3 cloud *************')
...
#
# copy content of backup to past
#
print_objects('transitanalystisrael-backup')
copy_bucket('transitanalystisrael-backup', 'transitanalystisrael-past')
print_objects('transitanalystisrael-past')

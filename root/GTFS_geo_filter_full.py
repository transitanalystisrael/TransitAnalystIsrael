...
def main(gtfspathin, gtfspathout, geo_filter):
    ...
    keep_stop_set = GTFS_geo_filter_util.filter_gtfsfile_by_in_set_gen_out_set(gtfspathin, gtfspathout, 'stop_times.txt', MAX_STOP_TIMES_COUNT, keep_trip_set, 'trip_id', 'stop_id')
    print("Local current time :", time.asctime( time.localtime(time.time()) ))

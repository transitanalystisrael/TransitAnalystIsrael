...
# in a GTFS file over the first two weeks of the entire service period 
# include breakdown of tpd per line (route short name) at each stop
#
# inputs:
#   parent_path = 'C:\\transitanalyst\\gtfs\\'
#   gtfsdir = 'israel20180106'
#
# outputs:
# output geojson file of stops with max and average trips per day and tpd per line (route short name) -'stops_w_tpd_per_line'+'_'+sstartservicedate+'.geojson'
...
print 'output geojson file of stops with max and average trips per day and tpd per line (route short name)'
...
#
# output txt file and geojson file
#_________________________________
#
parent_path = 'C:\\transitanalyst\\gtfs\\'
gtfsdir = 'israel20170108'
...
gtfspath = gtfspathin
gtfspathout = 'C:\\transitanalyst\\processed\\'

stopswithtripcountfile = 'stopswtripcountand10xforrail.txt'
...
for stop_id, [stop_desc, stop_lat, stop_lon, tripset, tpdlist, totaltpdatstop] in stops_dict.iteritems():
	...
	if totaltripsatstop >= maxtotaltripsanystop : print stop_id, stop_lat, stop_lon , list(tripset)[:2], tpdlist, totaltripsatstop
...
# output text file with total trip count per stop over service days counted - 'stopswtripcountand10xforrail.txt'
#
fileout = open(gtfspathout+stopswithtripcountfile, 'w') # save results in file
...
geojson_file_name = 'stops_w_tpd_per_line'+'_'+sstartservicedate+'.geojson'
geoj = {

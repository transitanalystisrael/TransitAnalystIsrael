...
#
# output to file of routes with tripcount and stops count - 'routeswtripcountperdaynorth.txt'
# output to file of unique routes - 'uniquerouteswtripcountat'+sstarttimename+sstoptimename+'north.txt'
...
routeswithtripcountfile = 'routeswtripcountperdaynorth.txt'
uniquerouteswithtripcountattimefile = 'uniquerouteswtripcountat'+sstarttimename+sstoptimename+'north.txt'

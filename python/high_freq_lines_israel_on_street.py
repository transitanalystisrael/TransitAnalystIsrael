...
#
high_freq_lines_w_tpd_v7.main('20181021', 'C:\\transitanalyst\\processed\\', 'israel_south', 'C:\\transitanalyst\\processed\\', '00:00:00', '24:00:00', 10)
print "Local current time :", time.asctime( time.localtime(time.time()) )
#
#def main(gtfsdate, gtfsparentpath, gtfsdirbase, pathout, sstarttime, sstoptime, freqtpdmin):
#
high_freq_lines_w_tpd_v7.main('20181021', 'C:\\transitanalyst\\processed\\', 'israel_north', 'C:\\transitanalyst\\processed\\', '00:00:00', '24:00:00', 10)
print "Local current time :", time.asctime( time.localtime(time.time()) )
#
#def main(gtfsdate, gtfsparentpath, gtfsdirbase, pathout, sstarttime, sstoptime, freqtpdmin):
#
high_freq_lines_w_tpd_v7.main('20181021', 'C:\\transitanalyst\\processed\\', 'israel_jerusalem', 'C:\\transitanalyst\\processed\\', '00:00:00', '24:00:00', 10)
print "Local current time :", time.asctime( time.localtime(time.time()) )
#
#def main(gtfsdate, gtfsparentpath, gtfsdirbase, pathout, sstarttime, sstoptime, freqtpdmin):
#
high_freq_lines_w_tpd_v7.main('20181021', 'C:\\transitanalyst\\processed\\', 'israel_telavivmetro', 'C:\\transitanalyst\\processed\\', '00:00:00', '24:00:00', 10)
print "Local current time :", time.asctime( time.localtime(time.time()) )
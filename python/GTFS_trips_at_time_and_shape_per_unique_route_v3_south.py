...
#
# output to file of routes with tripcount and stops count - 'routeswtripcountperdaysouth.txt'
# output to file of unique routes - 'uniquerouteswtripcountat'+sstarttimename+sstoptimename+'south.txt'
# output geojson file of routes with name max trips per day and shape geometry - 
#   'route_freq_at'+sstarttimename+sstoptimename+'_'+sstartservicedate+'south.geojson'
#
...
routeswithtripcountfile = 'routeswtripcountperdaysouth.txt'
uniquerouteswithtripcountattimefile = 'uniquerouteswtripcountat'+sstarttimename+sstoptimename+'south.txt'
...
if (endservicedate.toordinal()-startservicedate.toordinal()) > 7 :  endservicedate = startservicedate + timedelta(days=6)
print 'startservicedate, endservicedate ', startservicedate, endservicedate
...
postsline += 'day1,tpd1,day2,tpd2,day3,tpd3,day4,tpd4,day5,tpd5,day6,tpd6,day7,tpd7,stopsperroute\n'
...
for route_id, [agency_id,route_short_name,route_long_name,route_desc,route_type, tripset, tpdlist, totaltpdperroute, stopset] in routes_dict.iteritems():
	...
	if route_id not in used_route_id_set :
		...
		for route_id2, [agency_id2,route_short_name2,route_long_name2,route_desc2,route_type2, tripset2, tpdlist2, totaltpdperroute2, stopset2] in routes_dict.iteritems():
			...
			same_or_similar = same_stops or (percent_common_stops > 10 and route_short_name == route_short_name2 and agency_id != '2') # Not train!!!
		...
		if maxtpd >= FREQUENT_TPD and totaltpd > maxtpd*3: 
		...
		if maxtpd >= FREQUENT_TPD and totaltpd <= maxtpd*3: print "filtered out :", postsline
...
# saveGeoJSON
print ("Generating GeoJSON export.")
geojson_file_name = 'route_freq_at'+sstarttimename+sstoptimename+'_'+sstartservicedate+'south.geojson'
geoj = {
	"type": "FeatureCollection",

...
#
# outputs:
#   txt file of routes with tripcount and stops count - 'routeswtripcountperday'+region_name+'.txt'
#   txt file of unique routes - 'uniquerouteswtripcountat'+sstarttimename+sstoptimename+region_name+'.txt'
#   js file of routes with name max trips per day and shape geometry - 'route_freq_at'+sstarttimename+sstoptimename+'_'+sstartservicedate+region_name+'.js'
#   txt file for histogram of samestops for route_id pairs - samestopshist.txt
#
print '----------------- count the number of trips per day for all lines --------------------------'
...
#
parent_path = 'C:\\transitanalyst\\processed\\'
gtfsdir = 'israel20181021-jerusalem'
region_name = 'jerusalem'
...
routeswithtripcountfile = 'routeswtripcountperday'+region_name+'.txt'
uniquerouteswithtripcountattimefile = 'uniquerouteswtripcountat'+sstarttimename+sstoptimename+region_name+'.txt'
